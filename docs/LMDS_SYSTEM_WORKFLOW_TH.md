...
ไฟล์นี้อธิบายระบบ LMDS จากโค้ดจริงในโปรเจกต์ ณ วันที่ 2026-06-21 (V5.5.021 REFACTOR_CYCLE6_RESIDUAL, 17 audit cycles complete) โดยเน้นว่าแต่ละชีตทำงานร่วมกันอย่างไร คอลัมน์ใดเป็นจุดเชื่อม และกฎธุรกิจล่าสุดของ Group 2 ที่ต้องใช้ `ShipToName` เท่านั้นในการค้นหาพิกัด
